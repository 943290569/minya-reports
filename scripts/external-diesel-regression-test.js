...
const styles = read("public/external-diesel.css");
...
assert(api.includes('app.get("/api/external-diesel/suggestions"'), "driver and vehicle suggestions route is missing");
...
assert(page.includes('id="edQuickBody"'), "quick entry table is missing");
assert(page.includes('id="edDrivers"'), "driver autocomplete list is missing");
assert(page.includes('id="edVehicles"'), "vehicle autocomplete list is missing");
...
assert(client.includes("saveQuickRows"), "quick batch save is missing");
assert(client.includes("applyDriverSuggestion"), "driver to vehicle suggestion is missing");
assert(client.includes("applyVehicleSuggestion"), "vehicle to driver suggestion is missing");
assert(client.includes("incrementReceipt"), "automatic receipt increment is missing");
assert(client.includes('data-label="اسم السائق"'), "quick entry mobile field labels are missing");
assert(!client.includes(" · الشركة ${source}"), "company name is duplicated in the list subtitle");

...
(function(){
  ...
  async function show(title,body,href='/'){
    ...
    try{
      ...
      await reg.showNotification(title,{body,icon:'/assets/app-icon-192.png',badge:'/assets/app-icon-192.png',tag:`minya-${title}-${body}`.slice(0,120),renotify:false,data:{href}});
    }catch(_){ }
  }

...
(function(){
  ...
  function loadSharedEnhancements(){
    ...
    loadStyleOnce('/local-notifications.css?v=stable10-push1','data-minya-local-notifications-style');
    loadScriptOnce('/js/app-local-notifications.js?v=stable10-push1','data-minya-local-notifications');

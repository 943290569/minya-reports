...
(function(){
  ...
  function loadApproval(){if(document.querySelector('script[data-source-approve-v2]'))return;const s=document.createElement('script');s.src='js/app-source-approve-v2.js?v=3.3.0-source-approve-v3';s.dataset.sourceApproveV2='1';document.body.appendChild(s);}
